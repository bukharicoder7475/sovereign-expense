  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      <div className="page-header" style={{ textAlign: 'center', marginBottom: 48 }}>
        <img src="/logo.svg" alt="Sovereign" style={{ width: 72, height: 72, marginBottom: 20, opacity: 0.8 }} />
        <h2 style={{ fontSize: 32, letterSpacing: 2, marginBottom: 12 }}>SOVEREIGN</h2>
      ...
      <div className="card" style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14, marginBottom: 16 }}>
          Sovereign was born from a simple frustration: splitting bills with friends and colleagues was always more complicated than it needed to be. We watched people struggle with spreadsheets, forgotten debts, and uncomfortable reminders. We knew there had to be a better way.
        </p>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14, marginBottom: 16 }}>
          So we built Sovereign — a platform that handles the mathematics of shared living so you can focus on living. From splitting a dinner bill to managing household expenses among five roommates, from tracking group travel costs to settling office pool contributions, Sovereign does it all with a level of polish that matches the importance of your financial relationships.
        </p>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
          Every detail of Sovereign has been crafted with intention. The interface is clean and distraction-free. The calculations are precise to the cent. The experience is designed to make you feel confident that your finances are in order. Because when it comes to money, clarity isn't a luxury — it's a necessity.
        </p>
      </div>

      <div className="card" style={{ textAlign: 'center', padding: '40px 24px' }}>
        <h3 style={{ color: 'var(--silver-light)', marginBottom: 12, fontSize: 18 }}>Ready to Take Control?</h3>
        <p style={{ color: 'var(--text-muted)', marginBottom: 24, fontSize: 14 }}>Join Sovereign and experience expense management the way it should be.</p>
