  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>1. Acceptance of Terms</h3>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>2. Description of Service</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>3. User Responsibilities</h3>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>4. Financial Responsibility</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>5. Intellectual Property</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>6. Limitation of Liability</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>7. Termination</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>8. Changes to Terms</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ textAlign: 'center', padding: '32px 24px' }}>
        <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>
          ...
          <span style={{ color: 'var(--text-secondary)' }}>legal@ledgerly.app</span>
        </p>
      </div>
    </div>
  );
