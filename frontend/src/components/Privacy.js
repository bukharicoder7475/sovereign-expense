  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>1. Information We Collect</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14, marginBottom: 12 }}>
          When you use Ledgerly, we collect information that you provide directly and information generated through your use of the service.
        </p>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
          <strong style={{ color: 'var(--text-primary)' }}>Account Information:</strong> When you create an account, we collect your username, email address, and password. This information is necessary to provide you with access to the service and to identify you across sessions.
        </p>
      </div>

      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>2. How We Use Your Information</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
          We use the information we collect to provide, maintain, and improve our services. Your data helps us process expense splits, calculate balances, send notifications, and deliver email reports. We do not sell your personal information to third parties. We do not use your data for advertising purposes. Your financial data is used solely to power the features of Ledgerly that you choose to use.
        </p>
      </div>

      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>3. Data Storage and Security</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>6. Cookies and Tracking</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
          Ledgerly uses essential cookies to maintain your session and keep you signed in. We do not use tracking cookies or third-party analytics that monitor your behavior across other websites. Our cookies are strictly necessary for the functionality of the service.
        </p>
      </div>

      <div className="card" style={{ marginBottom: 20 }}>
        <h3 style={{ color: 'var(--text-primary)', marginBottom: 14, fontSize: 16 }}>7. Changes to This Policy</h3>
        <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8, fontSize: 14 }}>
          We may update this privacy policy from time to time. When we make material changes, we will notify you through the application or via email. Your continued use of Ledgerly after any changes constitutes acceptance of the updated policy.
        </p>
      </div>
      ...
      <div className="card" style={{ textAlign: 'center', padding: '32px 24px' }}>
        <p style={{ color: 'var(--text-muted)', fontSize: 13 }}>
          ...
          <span style={{ color: 'var(--text-secondary)' }}>privacy@ledgerly.app</span>
        </p>
      </div>
    </div>
  );
