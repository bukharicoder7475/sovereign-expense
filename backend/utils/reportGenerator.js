...
function createPDF(report) {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({
      ...
      info: {
        Title: `Ledgerly - ${report.monthName} ${report.year} Expense Report`,
        Author: 'Ledgerly',
      }
    });
    ...
    y += 12;
    doc.fontSize(7).fillColor(muted).font('Helvetica')
      .text('This report was automatically generated by Ledgerly. For questions, contact support.', 50, y, { align: 'center', width: 495 });
