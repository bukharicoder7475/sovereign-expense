...
function createPDF(report) {
  return new Promise((resolve, reject) => {
    const doc = new PDFDocument({
      ...
      info: {
        Title: `Sovereign - ${report.monthName} ${report.year} Expense Report`,
        Author: 'Sovereign',
      }
    });
    ...
    doc.fontSize(10).fillColor(muted).font('Helvetica')
      .text('SOVEREIGN', 50, 50, { continued: true })
    ...
    y += 12;
    doc.fontSize(7).fillColor(muted).font('Helvetica')
      .text('This report was automatically generated by Sovereign. For questions, contact support.', 50, y, { align: 'center', width: 495 });
